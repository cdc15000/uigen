...
// Consolidate all icons into one import
            ...
            <div className={cn(
              ...
              <div className={cn(
                ...
                <div className="text-sm">
                  {/* @ts-ignore - handling potential parts array from AI SDK */}
                  {message.parts ? (
                    <>
                      {message.parts.map((part: any, partIndex: number) => {
                        switch (part.type) {
                          ...
                          case "reasoning":
                            return (
                              <div key={partIndex} className="mt-3 p-3 bg-neutral-50 rounded-md border border-neutral-200">
